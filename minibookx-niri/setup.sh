...
sudo pacman -S base-devel git networkmanager openssh pipewire pipewire-pulse pipewire-alsa pipewire-jack wireplumber intel-ucode udisksie udisks2 mesa vulkan-intel tlp bluez bluez-utils playerctl
