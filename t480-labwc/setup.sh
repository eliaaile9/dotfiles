...
yay -S arc-darkest-theme-git bottles drawio-desktop-bin epson-inkjet-printer-escpr2 librewolf-bin obs-vkcapture papirus-icon-theme surfshark-client surfshark-vpn-cli-bin ttf-devicons ttf-font-awesome ttf-ioskeley-mono vimix-cursors
